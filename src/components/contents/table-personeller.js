...
export default function EnhancedTable() {
  ...
  <TableRow>
    ...
    <TableCell align="right">
      <TableSortLabel
        active={orderBy === "TC No"}
        direction={orderBy === "TC No" ? order : "asc"}
        onClick={() => handleRequestSort("TC No")}
      >
        TC No
      </TableSortLabel>
    </TableCell>
    ...
    <TableCell align="right">
      <TableSortLabel
        active={orderBy === "Telefon"}
        direction={orderBy === "Telefon" ? order : "asc"}
        onClick={() => handleRequestSort("Telefon")}
      >
        Telefon
      </TableSortLabel>
    </TableCell>
    ...
    <TableCell align="right">
      <TableSortLabel
        active={orderBy === "Arge Pozisyon"}
        direction={orderBy === "Arge Pozisyon" ? order : "asc"}
        onClick={() => handleRequestSort("Arge Pozisyon")}
      >
        Arge Pozisyon
      </TableSortLabel>
    </TableCell>
    <TableCell align="right">
      <TableSortLabel
        active={orderBy === "Firma Kategori"}
        direction={orderBy === "Firma Kategori" ? order : "asc"}
        onClick={() => handleRequestSort("Firma Kategori")}
      >
        Firma Kategori
      </TableSortLabel>
    </TableCell>
    <TableCell align="right">
      <TableSortLabel
        ...
        onClick={() => handleRequestSort("Durum")}
      >
        Durum
      </TableSortLabel>
    </TableCell>
    <TableCell align="right">
      <TableSortLabel
        active={orderBy === "Detay"}
        direction={orderBy === "Detay" ? order : "asc"}
        onClick={() => handleRequestSort("Detay")}
      >
        Detay
      </TableSortLabel>
    </TableCell>
