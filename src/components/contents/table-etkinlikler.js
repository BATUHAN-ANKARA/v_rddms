    ...
    <Paper sx={{ width: "100%", mb: 2 }}>
      <div className="flextbls">
        <Toolbar style={{ paddingLeft: '0px', marginLeft: '0px', float: 'left' }}>
          <h2 className="titlefirst">Güncel Tablo
</h2>
        </Toolbar>
          ...
          <TableHead>
            <TableRow>
              <TableCell
                align="left"
                padding="none"
                sortDirection={orderBy === "etkinlikadi" ? order : false}
              >
                <TableSortLabel
                  active={orderBy === "etkinlikadi"}
                  direction={orderBy === "etkinlikadi" ? order : "asc"}
                  onClick={() => handleRequestSort("etkinlikadi")}
                >
                 #
                </TableSortLabel>
              </TableCell>
              ...
              <TableCell align="right">
                <TableSortLabel
                  active={orderBy === "baslangictarihi"}
                  direction={orderBy === "baslangictarihi" ? order : "asc"}
                  onClick={() => handleRequestSort("baslangictarihi")}
                >
                  Başlangıç Tarihi
                </TableSortLabel>
              </TableCell>
              ...
              <TableCell align="right">
                <TableSortLabel
                  active={orderBy === "etkinlikyeri"}
                  direction={orderBy === "etkinlikyeri" ? order : "asc"}
                  onClick={() => handleRequestSort("etkinlikyeri")}
                >
                  Etkinlik Yeri
                </TableSortLabel>
              </TableCell>
              <TableCell align="right">
                <TableSortLabel
                  active={orderBy === "etkinlikkurulusadi"}
                  direction={orderBy === "etkinlikkurulusadi" ? order : "asc"}
                  onClick={() => handleRequestSort("etkinlikkurulusadi")}
                >
                  Etkinliği Sağlayan Kuruluş Adı
                </TableSortLabel>
              </TableCell>
              <TableCell align="right">
                <TableSortLabel
                  active={orderBy === "katilimsekli"}
                  direction={orderBy === "katilimsekli" ? order : "asc"}
                  onClick={() => handleRequestSort("katilimsekli")}
                >
                  Katılım Şekli
                </TableSortLabel>
              </TableCell>
            ...
            {visibleRows.map((row, index) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell align="right">{row.etkinlikkurulusadi}</TableCell>
