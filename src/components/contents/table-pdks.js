        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">
                {/* Eksik sütunları ekleyin */}
                <TableSortLabel>Projede Çalışma Süresi</TableSortLabel>
              </TableCell>
              <TableCell align="right">
                <TableSortLabel>Günlük Çalışma Süresi</TableSortLabel>
              </TableCell>
              <TableCell align="right">
                <TableSortLabel>Açıklama</TableSortLabel>
              </TableCell>
              <TableCell align="right">
                <TableSortLabel>Evden Çalışma</TableSortLabel>
              </TableCell>
              <TableCell align="right">
                <TableSortLabel>Özel Durum</TableSortLabel>
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {visibleRows.map((row, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Eksik sütunları ekleyin */}
                  <TableCell align="right">{row.projecalismasuresi}</TableCell>
                  <TableCell align="right">{row.gunlukcalismasuresi}</TableCell>
                  <TableCell align="right">{row.aciklama}</TableCell>
                  <TableCell align="right">{row.evdenCalisma}</TableCell>
                  <TableCell align="right">{row.ozelDurum}</TableCell>
                  <TableCell align="right">
                    {/* Düzenle button */}
                    <IconButton
